			...
			<div class="container container-tight py-4">
				...
				<div class="card card-md">
					<div class="card-body">
						...
						<form action="{$this->url(['controller'=>"users", 'action'=>"login"], "default")}" method="POST">
							<div class="mb-3">
							...
							<div class="mb-2">
								<label class="form-label" for="l_password">
									...
									{* <span class="form-label-description">
										<a href="{$this->url(['controller'=>"users", 'action'=>"recorver"], "default")}">I forgot password</a>
									</span> *}
								</label>
				...
				{* <div class="text-center text-secondary mt-3">Don't have account yet? <a href="{$this->url(['controller'=>"users", 'action'=>"register"], "default")}" tabindex="-1">Sign up</a></div> *}
